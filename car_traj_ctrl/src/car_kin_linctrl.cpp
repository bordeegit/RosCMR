...
void car_kin_linctrl::Prepare(void)
{
    ...
    /* ROS topics */
    vehicleState_subscriber = Handle.subscribe("/car_state", 1, &car_kin_linctrl::vehicleState_MessageCallback, this);
...
void car_kin_linctrl::RunPeriodically(float Period)
{
...
void car_kin_linctrl::Shutdown(void)
{
...
void car_kin_linctrl::vehicleState_MessageCallback(const std_msgs::Float64MultiArray::ConstPtr& msg)
{
...
void car_kin_linctrl::PeriodicTask(void)
{
