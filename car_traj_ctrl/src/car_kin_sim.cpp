...
void car_kin_sim::Prepare(void)
{
    ...
    /* ROS topics */
    vehicleCommand_subscriber = Handle.subscribe("/car_input", 1, &car_kin_sim::vehicleCommand_MessageCallback, this);
...
void car_kin_sim::RunPeriodically(void)
{
...
void car_kin_sim::Shutdown(void)
{
    // Delete ode object
    delete simulator;
...
void car_kin_sim::vehicleCommand_MessageCallback(const std_msgs::Float64MultiArray::ConstPtr& msg)
{
...
void car_kin_sim::PeriodicTask(void)
{
    /*  Integrate the model */
    simulator->integrate();
